...
// global variable #############################################
bool  O_tokens = false, O_ast = false, O_tac = false;
bool O_sa_scan=false, O_sa_parse=false, O_sa_ast=false;
...
Procedure_Node* procedure_root = new Procedure_Node(); //IMP for holding list of AST & TAC
...
int main(int argc, char const *argv[]){
	...
	strcat(tok_file, ".toks1");
	strcat(ast_file, ".ast1");
	strcat(tac_file, ".tac1");
